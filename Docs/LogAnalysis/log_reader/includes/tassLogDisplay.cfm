...
<cfquery datasource="OnlineReportsSQL" name="findInfo"><!--- ReptFileName, CategoryCode, ReportName --->
	select ReptFileName, ReportName
	from TassReportname
</cfquery> 
...
<!--- <th>Category</th> ---><th class="header">File Name</th><th class="header">Report Name</th><th class="header">count <cfoutput>#form.DateInfo#</cfoutput></th>
	...
	<cfquery datasource="OnlineReports" name="findInfo2007">
		...
		and filename like '%#ReptFileName#%'
				...
				<tr  bgcolor="###iif(currentrow MOD 2,DE('F8F8F8'),DE('eeeeee'))#">
					<!--- <td> none&nbsp;&nbsp; </td> ---><td class="content">#ReptFileName#</td>
