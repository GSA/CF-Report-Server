...
<!--- NGL:: Retreive all reports related to TARPS --->
...
In this section, you may find all report materials pertaining to <strong>#UCase(report)#</strong>
					...
					<table cellpadding="2" cellspacing="1" border="0" bgcolor="666666" width="#report_width_space#">
						...
						<cfform action="#CGI.SCRIPT_NAME#?report=#report#&display_result=daily_tarps" method="post" name="when">
						<tr bgcolor="FFFFFF">
							<td width="40%">
					...
					<table cellpadding="2" cellspacing="1" border="0" bgcolor="666666" width="#report_width_space#">
						...
						<cfform action="#CGI.SCRIPT_NAME#?report=#report#&display_result=daterange_tarps" method="post">
						<tr bgcolor="FFFFFF">
						...
						<tr bgcolor="FFFFFF">
						 <td colspan="3" width="100%" class="pageheaderOrange">
							...
							<select name="reportfile" class="content" size="5" style="width:300px; ">
								...
								<option value="#CatagoryCode#" <cfif client.reportfile is '#qy_GetCategory.CatagoryCode#'>selected</cfif>>#ReptFileName# - #ReportFreq# - #ReportName#</option>
								</cfloop>
							</select> 
							</td>
						</tr>
					...
					<table cellpadding="2" cellspacing="1" border="0" bgcolor="666666" width="#report_width_space#">
						<cfform action="#CGI.SCRIPT_NAME#?report=#report#&display_result=currentyear_tarps" method="post">
						<tr bgcolor="FFFFFF">
							<td>
							<br>
							<ul>
