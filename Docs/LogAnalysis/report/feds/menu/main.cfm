...
<!--- NGL:: Get All FEDS Reports --->
<cfinclude template="../sql/qy_GetCategory.cfm">
<!--- NGL:: Get All FEDS regions --->
...
In this section, you may find all report materials pertaining to <strong>#UCase(report)#</strong>
					...
					<table cellpadding="2" cellspacing="1" border="0" bgcolor="666666" width="#report_width_space#">
						...
						<cfform action="#CGI.SCRIPT_NAME#?report=#report#&display_result=daily_feds" method="post" name="when">
						<tr bgcolor="FFFFFF">
					...
					<img src="images/icons/red_right.jpg" alt="click here to start your search for a report based on a date range" border="0" align="absmiddle">&nbsp;<font color="CC3300">[!! STILL IN TESTING !!]</font> Search for a report based on a date range
					</div>
					...
					<table cellpadding="2" cellspacing="1" border="0" bgcolor="666666" width="#report_width_space#">
						...
						<cfform action="#CGI.SCRIPT_NAME#?report=#report#&display_result=daterange_feds" method="post">
						<tr bgcolor="FFFFFF">
							<td width="#report_width_space#">
								<table>
									<tr>
										<td>
										Regions:<br>
										<cfselect name="ReptRegion" query="qy_GetRegion"  value="RegionNo" display="RegionName" message="Select a Region before proceeding" required="yes" class="content" size="1" style="width:175px; " selected="#client.ReptRegion#"><option value="ASREQ">ASREQ</option><option value="NW">NW</option></cfselect>
										</td>
									</tr>
								</table>
							</td>
							...
							<table>
								 <tr>
									  <td>
									  From:<br><cfinput type="text" name="fromdate" value="" size="10" maxlength="10" class="content" message="Please select a starting date" required="yes">&nbsp;<a href="javascript:NewCal('Fromdate','MMddyyyy')"><img src="images/icons/calendarmenu.gif" border="0" alt="Choose your starting date" align="absmiddle"></a>
									  </td>
								 </tr>
								 <tr>
									  <td>
									  To:<br><cfinput type="text" name="todate" value="" size="10" maxlength="10" class="content" message="Please select a ending date" required="yes">&nbsp;<a href="javascript:NewCal('todate','MMddyyyy')"><img src="images/icons/calendarmenu.gif" border="0" alt="Choose your ending date" align="absmiddle"></a>							
									  </td>
								 </tr>
							</table>			
							</td>
						...
						<tr bgcolor="FFFFFF">
						 <td colspan="3" width="100%" class="pageheaderOrange">
							 Select a Report: <br>
							<select name="reportfile" class="content" size="1" style="width:400px; ">
								<cfloop query="qy_GetCategory">
								<option value="#ReptFileName#" <cfif client.reportfile is '#qy_GetCategory.ReptFileName#'>selected</cfif>>#ReptFileName# - #ReportName#</option>
								</cfloop>
							</select> 
							</td>
						</tr>
					...
					<table cellpadding="2" cellspacing="1" border="0" bgcolor="666666" width="#report_width_space#">
						<cfform action="#CGI.SCRIPT_NAME#?report=#report#&display_result=currentyear_feds" method="post">
						<tr bgcolor="FFFFFF">
							<td>
							<br>
							<ul>
