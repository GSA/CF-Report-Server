...
<cfinclude template="../logic/logic_prime_monthly.cfm">
...
<table cellpadding="2" cellspacing="1" border="0" bgcolor="666666" width="#report_width_space#" align="center" class="Raised">
	...
	<tr bgcolor="FFFFFF">
		<td colspan="3" width="#report_width_space#" class="pageheaderOrange">
			#nbr_report_result# results returned for the Monthly report on <cfif IsDefined("form.ReptRegion")>Region #form.ReptRegion#</cfif> in <cfif IsDefined("form.month_selected")>#MonthAsString(form.month_selected)#</cfif> <cfif IsDefined("form.year_selected")>#form.year_selected#</cfif>
		</td>
	</tr>
