...
<cfdirectory action="list" name="content" directory="#rootdir#\#session.year#\#ReptRegion#\IE\#ReptDate#\" filter="*.RTF"><!--- #GetReportName.ReptFreqCode# --->
<cfset linkurl = "#ServerUrl##report#/#session.year#/#ReptRegion#/IE/#ReptDate#/"><!--- #GetReportName.ReptFreqCode# --->
