...
<cfif (IsDefined("form.reportlevel") and form.reportlevel gt 0) and (IsDefined("form.month_selected") and form.month_selected gt 0) and (IsDefined("form.year_selected") and form.year_selected gt 0) >
...
<table cellpadding="2" cellspacing="1" border="0" bgcolor="666666" width="#report_width_space#" align="center" class="Raised">
	...
	<tr bgcolor="FFFFFF">
		<td width="#report_width_space#" valign="top">
