...
In this section, you may find all report materials pertaining to <strong>#UCase(report)#</strong>
					...
					<table cellpadding="2" cellspacing="1" border="0" bgcolor="666666" width="#report_width_space#">
						...
						<cfform action="#CGI.SCRIPT_NAME#?report=#report#&display_result=daily_sasy" method="post" name="when">
						<tr bgcolor="FFFFFF">
							<td width="40%">
					...
					<table cellpadding="2" cellspacing="1" border="0" bgcolor="666666" width="#report_width_space#">
						...
						<cfform action="#CGI.SCRIPT_NAME#?report=#report#&display_result=daterange_sasy" method="post">
						<tr bgcolor="FFFFFF">
					...
					<table cellpadding="2" cellspacing="1" border="0" bgcolor="666666" width="#report_width_space#">
						<cfform action="#CGI.SCRIPT_NAME#?report=#report#&display_result=currentyear_sasy" method="post">
						<tr bgcolor="FFFFFF">
							<td>
							<br>
							<ul>
