<cfmodule name="StdPortalPageInsitex" homebar="False" statusbar="False"  banner="/_images/BannerReports.jpg" 
 title="Online Reports"  topline="No" gsalogo="No" sidenavname="" leftnav="FALSE" bottomnav="No"
 tabbar="FALSE">  
 
<CFINCLUDE template="Authenticate.cfm" >

<cfset reports1 = "192.168.114.17">
...
<!-- begin: core content ------------------------------------------------------>
      ...
      <tr>
      	<td>&nbsp;</td>
      	<td>
      		<h2>FEDS Personal Property Reports</h2>
      		<ul>
	  ...
	  <td>&nbsp;</td>
      	<td>
			<h2>Computers for Learning Reports</h2>
      		<ul>
         		<li><a href="CFL/"><b>Computers for Learning Reports</b>&nbsp;-&nbsp;<font size="-1">Current Year  + History</font></a>
				<li><a href="searchsetup.cfm?action=begin&choice=CFL"><b>Search for a report based on a date range</a>
      		</ul>
	  ...
	  <td>&nbsp;</td>
      	<td>
      		<!--- <h2>FL Financial</h2>
      		<ul>
         		<li><a href="FL_Financial/"><b>CM4 Server in Crystal City, VA</b>&nbsp;-&nbsp;<font size="-1">Current Year  + History</font></a>
				<li><a href="searchsetup.cfm?action=begin&choice=FL Financial"><b>Search for a report based on a date range</a>
      		</ul> --->
      	</td>
      </tr> --->
      </table>
