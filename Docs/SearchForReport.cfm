			...
			<table align="center" width="700">
				...
				<cfloop condition="#searchyear# LTE #toyear#"> 
					...
					<cfElseif url.system is 'FSS19'>
						...
						<cfset thisdate = fdate>
						<cfset calcdate = form.fromdate>
							<!--- <cfoutput>#form.fromdate#  #fdate#  #thisdate# #tdate#</cfoutput>	 --->	
						<cfloop condition="tdate gt thisdate">														
							...
							<cfloop query="test">	
								...
								<TR>
									<td>#GetReportName.reportname#</td>
									<TD><a href="#linkurl##test.name#" target="_blank">#test.name#&nbsp;-&nbsp;#DateFormat(thisdate, "mm/dd/YYYY")#</a></TD>
									<td>#test.size#</td>
							...
							<cfset calcdate = DateAdd('d', 1, calcdate)>
							<cfset thisdate = DateFormat(CalcDate, 'yyyymmdd')>	
							<!--- <cfoutput>#thisdate#	#calcdate#</cfoutput> --->	
						</cfloop>		
					<cfElseif url.system is 'FEDS'>						
						...
						<cfelse>	
							...
							<cfset calcdate = form.fromdate>
							<cfset thisdate = DateFormat(CalcDate, 'mmddyy')>	
							<cfoutput>#form.fromdate#  #fdate#  #thisdate# #tdate#</cfoutput>
							<!--- <cfoutput>#form.fromdate#  #fdate#  #thisdate# #tdate#</cfoutput>	 --->	
							<cfloop condition="tdate gt thisdate">	
