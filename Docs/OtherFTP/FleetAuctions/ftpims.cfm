...
<cfftp action="LISTDIR" server="ftp.autoims.com"  username="GSA" password="giacsyofvu" stoponerror="Yes" name="Getfiles" directory="reports" connection="MyConn">
	...
	<CFLOOP query="Getfiles">
		<CFIF (Getfiles.name GT mostRecentFile) and (left(Getfiles.name, 6) EQ "20824_")>
...
<cfftp action="GETFILE" server="ftp.autoims.com"  username="GSA" password="giacsyofvu" stoponerror="Yes" localfile="D:\reports\docs\otherftp\FleetAuctions\dataFromIMS.csv" remotefile="reports/#mostRecentFile#" transfermode="AUTO" failifexists="No" connection="MyConn">
