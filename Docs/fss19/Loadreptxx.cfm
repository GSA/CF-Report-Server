...
<CFSET session.PreviousURL = "#ServerUrl#" & "fss19/cal.cfm?Month_day=#Month_day2#&Month=#Month2#&Year=#Year#">

<a href="#session.previousURL#"><img src="images/previous.gif" width=70 height=14 alt="" border="0"></a>
</UL>
</cfoutput>
