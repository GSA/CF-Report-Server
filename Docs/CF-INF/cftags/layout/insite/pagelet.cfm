<cfif compareNoCase(thisTag.executionMode,"start") eq 0>
	...
	<!--- 
		...
		LastUpdate date:
			...
			24/05/2003 by Benoit Hediard
				code optimisation
			19/05/2005 by Ryan Williams
				GSA/Insite specific changes (i.e. banner and application attributes)
		Description:
			Insert a pagelet 
	...
	<cfparam name="attributes.banner" type="string" default="insite" />
	<cfparam name="attributes.application" type="string" default="" />
	...
	<cfif not attributes.useCache or not doCacheExists or doRefreshCache>
		...
		<cfsavecontent variable="pageletContent">
			<cfif isDefined("attributes.parameters")>
				<cfmodule template="#application.virtualPaths.CFPAGELETS#/#pageletURL#" parameters="#attributes.parameters#" outputType="#attributes.outputType#" banner="#attributes.banner#" application="#attributes.application#">
			<cfelse>
				<cfmodule template="#application.virtualPaths.CFPAGELETS#/#pageletURL#" outputType="#attributes.outputType#" banner="#attributes.banner#" application="#attributes.application#">
			</cfif>
		</cfsavecontent>
