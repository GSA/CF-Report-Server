...
<cfelseif FindNoCase('B70011W3', session.FileName2)>
   <cfset srchname = 'B70011W3'>
<cfelseif FindNoCase('B70011W3-TOPS', session.FileName2)>
   <cfset srchname = 'B70011W3-TOPS'>
<cfelseif FindNoCase('B70011W3-WITS', session.FileName2)>
   <cfset srchname = 'B70011W3-WITS'>
<cfelseif FindNoCase('B70011W3-EMORRIS', session.FileName2)>
   <cfset srchname = 'B70011W3-EMORRIS'>
<cfelseif FindNoCase('B70009W1', session.FileName2)>
   <cfset srchname = 'B70009W1'>
<cfelseif FindNoCase('B70009W1-TOPS', session.FileName2)>
   <cfset srchname = 'B70009W1-TOPS'>
<cfelseif FindNoCase('B70009W1-WITS', session.FileName2)>
   <cfset srchname = 'B70009W1-WITS'>
<cfelseif FindNoCase('B70009W1-EMORRIS', session.FileName2)>
   <cfset srchname = 'B70009W1-EMORRIS'>
...
<cfelse>
   <cfset srchname = 'XXXXXXXXXXXXXXXXXXX'>
		...
		<cfquery name="getreport" datasource="OnLineReports">
			select	* from Baartestreportname
