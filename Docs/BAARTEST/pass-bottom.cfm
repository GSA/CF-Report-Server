...
<!--- 	<CFDIRECTORY action="list" directory="#session.directory#" name="contents" sort="name" filter="*.#url.extension#"> --->
	...
	<cfif getreport.recordcount is 0>
		...
		<tr>	
			<td><a href="pass-bottom.cfm?action=enter&file=<cfoutput>#url.file#</cfoutput>&ext=TXT">Click here to continue</a></td>
		</tr>
		</table>	
	<cfelse>
		<table>
		...
		<tr>	
			<td><a href="<cfoutput>#session.LinkURL##session.currentPWfile#</cfoutput>" onMouseOver="window.Status = 'Hello!';return true" onMouseOut="window.defaultStatus = 'Hello!';return true" onClick="window.Status = 'Hello!';return true" onkeyup="window.Status = 'Hello!';return true" onblur="window.Status = 'Hello!';return true" target="Frame-btm" >Click here to load the report</a></td>
		</tr>
		</table>	
	</cfif>	
</cfif>
