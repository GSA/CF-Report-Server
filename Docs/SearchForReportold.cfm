					...
					<cfElseif url.system is 'FSS19'>
						...
						<cfloop query="getdate">
							...
							<cfelse>
								...
								<cfoutput>#Directory1#, #linkurl#  #thisdate#  #thisdate2#</cfoutput><br> 
								...
								<cfloop query="test">	
									...
									<cfif reqcopy is 'Y'>
										<cffile action="copy" source="#Directory1#\#test.name#" destination="T:\reports\docs\copies\#DateFormat(thisdate2, "mmddyy")##test.name#">									
									</cfif>
									</cfoutput>
